...
import UploadHasil from './UploadHasil'
              ...
              <Nav pills className='mb-2'>
                ...
                <NavItem>
                  <NavLink active={active === '3'} onClick={() => toggleTab('3')}>
                    ...
                    <span className='fw-bold'>Upload File Akhir</span>
                  </NavLink>
                </NavItem>
              </Nav>
              <TabContent activeTab={active}>
                <TabPane tabId='1'>
                  <CardTurnitin dataUser={dataUser} dataTurnitin={dataTurnitin} />
                </TabPane>
                <TabPane tabId='2'>
                  <CardPembayaran dataUser={dataUser} />
                </TabPane>
                <TabPane tabId='3'>
                  <UploadHasil dataUser={dataUser} />
                </TabPane>
              </TabContent>
            </div>
          ) : (
